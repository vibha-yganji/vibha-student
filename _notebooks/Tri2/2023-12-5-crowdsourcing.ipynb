 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "A public dataset is any data that can be used used + distributed without any restrictions."
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "Distributed computing is the use of multiple processeser across a variety of laptops to compelte a single task."
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "Examples of crowdsourcing in modern life - Twtich"
   ]
  }
 ],
 "metadata": {
